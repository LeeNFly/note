 ...
 * @LastEditTime: 2020-04-13 22:07:07
 * @Description: 
 */
// ★ js对象中, 属性的简写形式  (对象中属性名不识别变量 属性值可以识别变量)
...
// ★ 在对象中, 属性名不能识别变量, 属性值可以识别变量, 变量的查找规则根据词法作用域规则来
// let obj = {
//     name
// }


// 2. 方法(函数属性)简写 : 对象中属性值为函数的属性的简写方式, 这边也只是声明函数, 不会调用
let obj = {
