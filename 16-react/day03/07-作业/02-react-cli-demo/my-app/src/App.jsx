    ...
    <div className="App">
      <HashRouter>
        ...
        <div>
          ...
          {/* 路由会自动监听地址栏URL中#锚点部分, 只要改变, 就会重新匹配路由规则Route, 然后只将当前URL#锚点匹配的那个路由规则对应的组件中render方法返回的编译后的jsx覆盖替换展示(拼接)到Route标签处 (会将这次匹配的组件render方法返回的jsx替换掉上次匹配组件render方法返回的jsx), 并且该部分jsx由组件内部数据自己维护*/}
