  ...
  return (
    <div className="App">
      <HashRouter>
        ...
        {/* URL中#锚点部分匹配的路由规则对应的那个组件返回的jsx会替换展示(拼接)到Route处, 并且该部分jsx由该组件内部自己维护 */}
        {/* Route中只会展示当前URL中#锚点部分匹配的路由规则Route对应的组件(jsx), 对于URL中#锚点部分没有匹配Route, 则Route中什么都不展示, 若之前有展示过, 则会清除*/}
        {/* 路由会自动监听地址栏URL中#锚点部分, 只要改变, 就会重新匹配路由规则Route, 然后只将当前URL#锚点匹配的那个路由规则对应的组件jsx覆盖替换展示(拼接)到Route处 */}
